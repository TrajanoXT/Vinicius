...
function Colors(){
    const Colors = [
        ...
        { id: 'silver', name: 'Titanio Natural', image:'/img/iphone-silver.jpg', colorClass: 'bg-gray-300'},
        ...
        <section id="colors" className="bg-black py-20 px-8">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-5xl mb:text-6xl front-bold mb-4 ">Escolha sua cor</h2>
                    <p>Quatro acabamentos em titanio lindos</p>
                </div>
                <div className="flex justify-center mb-12">
                    <div className="relative w-full max-w-3xl">
                        <div className="relative flex item-cente justify-center min-h-[500px]">
                ...
                <div className="grid gap-8 mt-20 grid-cols-2 ">
                    ...
                    <div className="text-center mt-16">
                        <button className="bg-blue-700 hover:bg-blue-800  text-white px-12 py-4 rounded-full text-lg font-medium transition-all durantion-300 mb-8 hover:scale-106 shadow-md shadow-blue-500/50 cursor-pointer">
                            Compre agora a partir de R$ 9.950,00
                        </button>
                        <p>Ou em ate 12x de R$ 994,92 </p>
                    </div>
            </div>
        </section>
    )
